...
public class RecipeSiphon {

	private ItemStack recipeOutput;
	private WrappedStack inputStack;
	private ItemStack dustStack;

	public RecipeSiphon(ItemStack recipeOutput, ItemStack inputStack, ItemStack dustStack) {
		this.recipeOutput = recipeOutput.copy();
		this.inputStack = new WrappedStack(inputStack);
		this.dustStack = dustStack.copy();
	}

	public RecipeSiphon(ItemStack recipeOutput, OreStack inputStack, ItemStack dustStack) {
		this.recipeOutput = recipeOutput.copy();
		this.inputStack = new WrappedStack(inputStack);
		this.dustStack = dustStack.copy();
	}
	...
	public boolean equals(Object object) {
		if (object instanceof RecipeSiphon) {
			return matches((RecipeSiphon) object);
		}
	...
	public boolean matches(RecipeSiphon recipeAludel) {
