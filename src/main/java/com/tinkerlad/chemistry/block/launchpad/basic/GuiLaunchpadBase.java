    ...
    public void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            case 0:
                ...
                ItemStack stack = this.inventorySlots.getSlot(1).getStack();
                if (stack.getItem() instanceof ItemCustomRocket) {
                    ...
                    EntityBasicRocket rocket = new EntityBasicRocket(earth, time, pitch, yaw, thrust);
                    rocket.posX = x;
                    rocket.posY = y + 1;
                    rocket.posZ = z;
