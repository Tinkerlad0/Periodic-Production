...
public class ItemElementHoe extends ItemHoe {
    public ItemElementHoe(ToolMaterial material) {
        super(material);
        this.setCreativeTab(null);
        this.setTextureName(Chemistry.MODID + ":hoe");
        this.setUnlocalizedName("elementHoe");
    }
    ...
    public void onCreated(ItemStack stack, World world, EntityPlayer player) {
        if (stack.stackTagCompound == null) {
            ...
            stack.stackTagCompound.setString("pp_name", "[default]");
        }
    }
}
